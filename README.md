...
Предусловие: 
Сервис может быть недоступен, если сайт не открывается, попробовать через VPN
...
Предусловие: 
Бэкенд не поддерживает множественную вставку данных, что может сломать тесты. Рекомендуется запускать синхронно.
